...
Account for clustering using **robust standard errors**: https://www.r-bloggers.com/2021/05/clustered-standard-errors-with-r/
...
df_clean <- 
  ...
  mutate(
    ...
    religion_recode=factor(case_when(religion%in%c("Islam", "None")~"Islam or None", TRUE~religion)),
...
table(df_clean$religion_recode)
...
vars_list=list(
  "age10_recode"=c("gender", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"), 
  "gender"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "m_status"=c("age_years", "I(age_years^2)", "gender", "health_area",  "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"), 
  # "health_area"=c("age_years", "I(age_years^2)",  "gender", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d"),
  "edu_recode"=c("age_years", "I(age_years^2)", "gender", "health_area", "m_status", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "employment_status"=c("age_years", "I(age_years^2)", "gender", "health_area", "m_status", "edu_recode", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "h_income"=c("age_years", "I(age_years^2)", "gender", "health_area", "m_status", "employment_status", "edu_recode", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "chronic_d"=c("age_years", "I(age_years^2)", "gender", "health_area", "m_status", "employment_status", "edu_recode", "h_income", "n_child", "I(n_child^2)", "religion_recode"),
  "parent_vax_any"=c("age_years", "I(age_years^2)", "gender", "health_area", "m_status", "employment_status", "edu_recode", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"), 
  "n_child5"=c("age_years", "I(age_years^2)", "gender", "health_area", "m_status", "employment_status", "edu_recode", "h_income", "chronic_d", "religion_recode")
)
...
forest.table <- map(
  ...
  ~transmute(
    ...
    p.robust=case_when(is.na(p.robust)~"", 
                       ...
                       TRUE~format(p.robust, nsmall=2, scientific=TRUE))
    )
...
for (cc in seq_along(plotdata)) { 
	...
	LinearPlot(
     ...
     margins           = list(c(2,5,3,1), c(2,2.5,3,2), c(2,2.5,3,2), c(2,5,3,1), c(2,2.5,3,2), c(2,2.5,3,2))[[cc]],
     xticklabs.cex     = 0.7, 
     yticklabs.cex     = 0.7,
	...
	# add axis labels
	AxisLabels(ylab=rep(list("\nOdds ratio (95% CI)", NULL, NULL), 3)[[cc]], xlab=x.Labels[cc], mainfont=0.8)
	par(xpd=NA)
...
vars_list=list(
  ...
  "child_recommended_vax"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "heard_of_hpv"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "heard_of_cc"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "is_cc_severe"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "child_vax_others"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "thinks_vax_safe"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "concern_adverse_rx"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "leaders_support_vax"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "trust_moh"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "trust_vax_comps"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode"),
  "received_badinfo"=c("age_years", "I(age_years^2)", "health_area", "m_status", "edu_recode", "employment_status", "h_income", "chronic_d", "n_child", "I(n_child^2)", "religion_recode")
)
