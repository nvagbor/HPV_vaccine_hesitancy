...
df_clean <- 
  ...
  mutate(
    ...
    employment_status=case_when(employment_status=="Umemployed" ~ "Unemployed", 
    ...
    knows_cc_vax_exist=case_when(heard_of_hpv=="No" & heard_of_cc=="No" ~ "Never heard of HPV or CC", 
                                 TRUE ~ knows_cc_vax_exist)
    )
